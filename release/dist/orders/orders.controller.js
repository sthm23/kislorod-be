...
const telegram_user_decorator_1 = require("../common/decorators/telegram-user.decorator");
let OrdersController = class OrdersController {
    ordersService;
    constructor(ordersService) {
        this.ordersService = ordersService;
    }
    create(createOrderDto, telegramUserId) {
        return this.ordersService.create(createOrderDto, telegramUserId?.toString());
    }
    findAll() {
        return this.ordersService.findAll();
    }
    async findMyOrders(telegramUserId) {
...
__decorate([
    ...
    __param(1, (0, telegram_user_decorator_1.TelegramUser)('id')),
...
__decorate([
    (0, common_1.Get)('my'),
    __param(0, (0, telegram_user_decorator_1.TelegramUser)('id')),
    __metadata("design:type", Function),
